...
class DtslScript_DSTREAM(DTSLv1):
    ...
    def doPinmux(self):
        # Set up pinmuxing
        self.cortexA9cores[0].memWrite(0x4300, 0xfc00ffb0, RDDI_ACC_SIZE.RDDI_ACC_DEF, 0x10000, False, 4, pack('<I', 0xc5acce55))
        self.cortexA9cores[0].memWrite(0x4300, 0xfc00f004, RDDI_ACC_SIZE.RDDI_ACC_DEF, 0x10000, False, 4, pack('<I', 0x00900000))
