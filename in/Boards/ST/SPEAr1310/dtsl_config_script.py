...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        # Be aware of the funnel ordering!

        # Funnel 1
        funnelDev1 = self.findDevice("CSTFunnel")
        self.funnel1 = self.createFunnel(funnelDev1, "Funnel_1")
        self.funnel1.setPortEnabled(0)

        # Funnel 0
        funnelDev0 = self.findDevice("CSTFunnel", funnelDev1+1)
    ...
    def getFunnelPortForCore(self, core):
        ...
        # Core 0 connected to port 1
        if core == 0:
            port = 1
        # Core 1 connected to port 0
        elif core == 1:
            port = 0
        else:
            port = core
