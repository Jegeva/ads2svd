...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores["daughterboard.core"] = Device(self, self.findDevice("daughterboard.core"), "ARM_Cortex-R4" )
    ...
    def setupModelTrace(self):
        ...
        self.tracecapture.addTraceSource(fmtSource, self.cores["daughterboard.core"].getID())
        fmtSource.setEnabled(True)


    def exposeCores(self):
        '''Expose cores'''
        self.addDeviceInterface(self.cores["daughterboard.core"])
