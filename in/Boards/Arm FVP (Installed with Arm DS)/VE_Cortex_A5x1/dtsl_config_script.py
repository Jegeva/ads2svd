...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.cores["cluster.cpu0"] = ConnectableDevice(self, self.findDevice("cluster.cpu0"), "ARM_Cortex-A5" )
        ...
        self.addPVCache(self.cores["cluster.cpu0"], self.caches["cluster.cpu0.l1icache"], self.caches["cluster.cpu0.l1dcache"])
