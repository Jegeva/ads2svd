...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores["armcortexm0ct"] = Device(self, self.findDevice("armcortexm0ct"), "ARM_Cortex-M0" )
    ...
    def setupModelTrace(self):
        ...
        self.tracecapture.addTraceSource(fmtSource, self.cores["armcortexm0ct"].getID())
        fmtSource.setEnabled(True)


    def exposeCores(self):
        '''Expose cores'''
        self.addDeviceInterface(self.cores["armcortexm0ct"])
