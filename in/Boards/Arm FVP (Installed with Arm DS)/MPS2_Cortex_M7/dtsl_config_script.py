...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.cores["armcortexm7ct"] = Device(self, self.findDevice("armcortexm7ct"), "ARM_Cortex-M7" )
    ...
    def setupModelTrace(self):
        ...
        self.tracecapture.addTraceSource(fmtSource, self.cores["armcortexm7ct"].getID())
        fmtSource.setEnabled(True)


    def exposeCores(self):
        '''Expose cores'''
        self.addDeviceInterface(self.cores["armcortexm7ct"])
