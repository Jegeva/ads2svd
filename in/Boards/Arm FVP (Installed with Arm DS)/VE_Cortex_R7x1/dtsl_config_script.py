...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.cores["daughterboard.core.cpu0"] = ConnectableDevice(self, self.findDevice("daughterboard.core.cpu0"), "ARM_Cortex-R7" )


        self.caches = dict()
        self.caches["daughterboard.core.cpu0.l1dcache"] = PVCacheDevice(self, self.findDevice("daughterboard.core.cpu0.l1dcache"), "l1dcache_0")
        self.caches["daughterboard.core.cpu0.l1icache"] = PVCacheDevice(self, self.findDevice("daughterboard.core.cpu0.l1icache"), "l1icache_0")
