...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.createModelCore("coretile.cluster0.cpu0", "ARM_Cortex-A15_0", "Cortex-A15")
        self.createModelCore("coretile.cluster0.cpu1", "ARM_Cortex-A15_1", "Cortex-A15")
        self.createModelCore("coretile.cluster0.cpu2", "ARM_Cortex-A15_2", "Cortex-A15")
        self.createModelCore("coretile.cluster0.cpu3", "ARM_Cortex-A15_3", "Cortex-A15")
        ...
        self.caches = dict()
        self.caches["coretile.cluster0.cpu0.l1dcache"] = PVCacheDevice(self, self.findDevice("coretile.cluster0.cpu0.l1dcache"), "l1dcache_0")
        self.caches["coretile.cluster0.cpu0.l1icache"] = PVCacheDevice(self, self.findDevice("coretile.cluster0.cpu0.l1icache"), "l1icache_0")
        self.caches["coretile.cluster0.cpu1.l1dcache"] = PVCacheDevice(self, self.findDevice("coretile.cluster0.cpu1.l1dcache"), "l1dcache_1")
        self.caches["coretile.cluster0.cpu1.l1icache"] = PVCacheDevice(self, self.findDevice("coretile.cluster0.cpu1.l1icache"), "l1icache_1")
        self.caches["coretile.cluster0.cpu2.l1dcache"] = PVCacheDevice(self, self.findDevice("coretile.cluster0.cpu2.l1dcache"), "l1dcache_2")
        self.caches["coretile.cluster0.cpu2.l1icache"] = PVCacheDevice(self, self.findDevice("coretile.cluster0.cpu2.l1icache"), "l1icache_2")
        self.caches["coretile.cluster0.cpu3.l1dcache"] = PVCacheDevice(self, self.findDevice("coretile.cluster0.cpu3.l1dcache"), "l1dcache_3")
        self.caches["coretile.cluster0.cpu3.l1icache"] = PVCacheDevice(self, self.findDevice("coretile.cluster0.cpu3.l1icache"), "l1icache_3")
        self.caches["coretile.cluster0.l2_cache"] = PVCacheDevice(self, self.findDevice("coretile.cluster0.l2_cache"), "l2_cache")
        ...
        self.addPVCache(self.cores["coretile.cluster0.cpu0"], self.caches["coretile.cluster0.cpu0.l1icache"], self.caches["coretile.cluster0.cpu0.l1dcache"], self.caches["coretile.cluster0.l2_cache"])
        self.addPVCache(self.cores["coretile.cluster0.cpu1"], self.caches["coretile.cluster0.cpu1.l1icache"], self.caches["coretile.cluster0.cpu1.l1dcache"], self.caches["coretile.cluster0.l2_cache"])
        self.addPVCache(self.cores["coretile.cluster0.cpu2"], self.caches["coretile.cluster0.cpu2.l1icache"], self.caches["coretile.cluster0.cpu2.l1dcache"], self.caches["coretile.cluster0.l2_cache"])
        self.addPVCache(self.cores["coretile.cluster0.cpu3"], self.caches["coretile.cluster0.cpu3.l1icache"], self.caches["coretile.cluster0.cpu3.l1dcache"], self.caches["coretile.cluster0.l2_cache"])
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "ARM_Cortex_A15_SMP", self.cluster0cores)
        self.addDeviceInterface(smp)

        # cluster1 SMP
        smp = CadiSyncSMPDevice(self, "ARM_Cortex_A7_SMP", self.cluster1cores)
        self.addDeviceInterface(smp)
    ...
    def setupCadiBigLittle(self):
        ...
        bigLITTLE = CadiSyncSMPDevice(self, "ARM_Cortex_A15_A7_big_LITTLE", cores)
