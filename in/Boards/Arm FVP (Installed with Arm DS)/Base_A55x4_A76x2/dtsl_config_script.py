...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.createModelCore("cluster0.cpu4", "Cortex-A76_0", "Cortex-A76")
        self.createModelCore("cluster0.cpu5", "Cortex-A76_1", "Cortex-A76")
    ...
    def setupCadiSyncSMP(self):
        ...
        # Cortex-A55x4_Cortex-A76x2 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A55x4_Cortex-A76x2 SMP", self.cluster0cores)
