...
BASE_IDX_CORE_0 = 3 # base core index in .rvc + 1 (for T88 using: AP0 = 3, AP1 = 4)
...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        for i in range(0, NUM_CORES_THUNDERX):
            ...
            core = thunderx_config.ThunderXCoreDevice(self, coreIdx, "ThunderX-r2_%02d" % i)
...
class DtslScript_SMP(DtslScript):
    ...
    def setupCTISyncSMP(self):
        ...
        smp = CTISyncSMPDevice(self, "ThunderX-r2 SMP", self.thunderXcores, ctiInfo, CTM_CHANNEL_SYNC_START, CTM_CHANNEL_SYNC_STOP)
