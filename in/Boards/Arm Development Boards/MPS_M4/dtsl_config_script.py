...
class DtslScript(DTSLv1):
        ...
        return DTSLv1.tabPage("coreTrace", "Core Trace", childOptions=[
                    DTSLv1.booleanOption('cortexM4coreTrace', 'Enable Cortex-M4 core trace', defaultValue=False,
                        childOptions =
                            ...
                            [ DTSLv1.booleanOption('Cortex_M4_%d' % c, "Enable Cortex-M4 %d trace" % c, defaultValue=True)
                            for c in range(0, NUM_CORES_CORTEX_M4) ]
                            # <s>Pull in common options for ETMs</s> Cycle-accurate trace unsupported by ETM.
    ...
    def getOptionITMTabPage():
        pass
        # Doesn't work - complains that no ITM port configured...sometimes.
    ...
    def discoverDevices(self):
        ...
        for i in range(0, NUM_CORES_CORTEX_M4):
            ...
            etm = M4_ETM(self, etmDev, streamID, "ETM_%d_%d" % (i, streamID))
            streamID += 1
    ...
    def optionValuesChanged(self):
        ...
        for i in range(0, NUM_CORES_CORTEX_M4):
            thisCoreTraceEnabled = self.getOptionValue("options.coreTrace.cortexM4coreTrace.Cortex_M4_%d" % i)
        ...
        self.setInternalTraceRange(self.traceRangeOptions[CORTEX_M4_TRACE_OPTIONS], TraceRangeOptions("cortexM4coreTrace", self), self.ETMs[etmStartIndex:etmEndIndex])
    ...
    # Doesn't work - complains that no ITM port configured.
    ...
    def registerFilters(self, core):
        ''' allow access to AHB via the MEMAP template'''
