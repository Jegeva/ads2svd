...
class DtslScript(DTSLv1):
        ...
        return DTSLv1.tabPage("traceBuffer", "Trace Buffer", childOptions=[
                    DTSLv1.enumOption(
                        ...
                        values=[("none", "None"),
                                ...
                                ("ETF0", "On Chip Trace Buffer (ETF0 - A57/A53 Core Trace Only)"),
    ...
    def discoverDevices(self):
        ...
        self.funnelApps.setPortEnabled(0)  # A57 trace port always enabled here - controlled in cluster funnel
    ...
    def setupDSTREAMTrace(self, portWidth):
        ...
        self.DSTREAM.setTraceComponentOrder(
                         [self.funnelA57, self.funnelA53, self.funnelM3, self.funnelApps, self.funnelSCP,
        ...
        self.addManagedTraceDevices("DSTREAM",
                 [self.funnelMaster, self.funnelApps, self.funnelSCP, self.funnelA57, self.funnelA53,
    ...
    def setupETRTrace(self):
        ...
        self.ETR.setTraceComponentOrder([self.funnelM3, self.funnelA57, self.funnelA53,
        ...
        # automatically handle connection/disconnection to trace components
        self.addManagedTraceDevices("ETR", [self.funnelMaster, self.funnelApps, self.funnelSCP, self.funnelA57,
    ...
    def setupETFTrace0(self):
        ...
        self.etfTrace0.setTraceComponentOrder([self.funnelM3, self.funnelA57,
        ...
        self.addManagedTraceDevices(
            "ETF0", [self.funnelM3, self.funnelA57, self.funnelA53, self.funnelApps,
