...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        for i in range(0, NUM_CORES_CORTEX_M1):
            # create core
            cortexM1coreDev = self.findDevice("Cortex-M1", cortexM1coreDev+1)
            dev = Device(self, cortexM1coreDev, "Cortex-M1")
            self.cortexM1cores.append(dev)

    def exposeCores(self):
        for core in self.cortexM1cores:
