...
class DtslScript_DSTREAM(DTSLv1):
        ...
        return [
            DTSLv1.tabSet("options", "Options", childOptions=[
                DTSLv1.tabPage("system", "System", childOptions=[
                    DTSLv1.booleanOption('disM3rst', 'Clear Cortex-M3 software reset 2', defaultValue=False),
                ]),
                ...
                DTSLv1.tabPage("itm", "ITM", childOptions=[
                    ...
                    DTSLv1.booleanOption('ITM1', 'Enable ITM 1 trace', defaultValue=False),
                ]),
    ...
    def configureM3reset(self, core):
        try:
            core.memWrite(0, 0xA00B0B00, RDDI_ACC_SIZE.RDDI_ACC_DEF, RDDI.RDDI_MRUL_NORMAL, False, 4, pack('<I', 0x0000A502))    # disable the protect on register
            core.memWrite(0, 0xA00B0220, RDDI_ACC_SIZE.RDDI_ACC_DEF, RDDI.RDDI_MRUL_NORMAL, False, 4, pack('<I', 0x00000000))    # disable Cortex-M3 reset
            core.memWrite(0, 0xA00B0B00, RDDI_ACC_SIZE.RDDI_ACC_DEF, RDDI.RDDI_MRUL_NORMAL, False, 4, pack('<I', 0x0000A500))    # enable the protect on register
        except:
            # failed
            pass
    ...
    def setCoreConfiguration(self):
        ...
        coreM3ResetDisabled = self.getOptionValue("options.system.disM3rst")
        coreTraceEnabled = self.getOptionValue("options.cortexR4.coreTrace")

        if coreTraceEnabled and self.TPIU.getEnabled() or coreM3ResetDisabled:
            try:
        ...
        if coreM3ResetDisabled and coreOpen:
            self.configureM3reset(core)    # disable Cortex-M3 reset
    ...
    def getTMForCore(self, core):
        ...
        coreTMMap[self.cortexM3cores[0]] = self.ETMs[1]
    ...
    def setInitialOptions(self):
        ...
        itmEnabled = self.getOptionValue("options.itm.ITM1")
        self.setTraceSourceEnabled(self.ITM1, itmEnabled)
