...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores["cluster.cpu0"] = ConnectableDevice(self, self.findDevice("cluster.cpu0"), "ARM_Cortex-A53_0" )
        self.cores["cluster.cpu1"] = ConnectableDevice(self, self.findDevice("cluster.cpu1"), "ARM_Cortex-A53_1" )
        self.cores["cluster.cpu2"] = ConnectableDevice(self, self.findDevice("cluster.cpu2"), "ARM_Cortex-A53_2" )
        self.cores["cluster.cpu3"] = ConnectableDevice(self, self.findDevice("cluster.cpu3"), "ARM_Cortex-A53_3" )
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A53x4 SMP", self.cluster0cores)
