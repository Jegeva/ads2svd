...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.createModelCore("cluster0.cpu0", "ARM_Cortex-A72_0", "Cortex-A72")
        self.createModelCore("cluster0.cpu1", "ARM_Cortex-A72_1", "Cortex-A72")
        self.createModelCore("cluster0.cpu2", "ARM_Cortex-A72_2", "Cortex-A72")
        self.createModelCore("cluster0.cpu3", "ARM_Cortex-A72_3", "Cortex-A72")
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "ARM_Cortex-A72x4 SMP", self.cluster0cores)
