...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.cores["cluster0.cpu0"] = ConnectableDevice(self, self.findDevice("cluster0.cpu0"), "ARM_Cortex-A32_0" )
        self.cores["cluster0.cpu1"] = ConnectableDevice(self, self.findDevice("cluster0.cpu1"), "ARM_Cortex-A32_1" )
        self.cores["cluster0.cpu2"] = ConnectableDevice(self, self.findDevice("cluster0.cpu2"), "ARM_Cortex-A32_2" )
        self.cores["cluster0.cpu3"] = ConnectableDevice(self, self.findDevice("cluster0.cpu3"), "ARM_Cortex-A32_3" )
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "Debug Cortex-A32x4 SMP", self.cluster0cores)
