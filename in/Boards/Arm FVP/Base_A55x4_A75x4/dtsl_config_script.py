...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.createModelCore("cluster0.cpu0", "Cortex-A55_0", "Cortex-A55")
        self.createModelCore("cluster0.cpu1", "Cortex-A55_1", "Cortex-A55")
        self.createModelCore("cluster0.cpu2", "Cortex-A55_2", "Cortex-A55")
        self.createModelCore("cluster0.cpu3", "Cortex-A55_3", "Cortex-A55")
        self.createModelCore("cluster0.cpu4", "Cortex-A75_0", "Cortex-A75")
        self.createModelCore("cluster0.cpu5", "Cortex-A75_1", "Cortex-A75")
        self.createModelCore("cluster0.cpu6", "Cortex-A75_2", "Cortex-A75")
        self.createModelCore("cluster0.cpu7", "Cortex-A75_3", "Cortex-A75")
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A55x4_Cortex-A75x4 SMP Cluster 0", self.cluster0cores)
