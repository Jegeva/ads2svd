...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.createModelCore("cluster0.cpu0", "Cortex-A76_0", "Cortex-A76")
        self.createModelCore("cluster0.cpu1", "Cortex-A76_1", "Cortex-A76")
        self.createModelCore("cluster0.cpu2", "Cortex-A76_2", "Cortex-A76")
        self.createModelCore("cluster0.cpu3", "Cortex-A76_3", "Cortex-A76")
    ...
    def setupCadiSyncSMP(self):
        ...
        # Cortex-A76x4 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A76x4 SMP", self.cluster0cores)
