...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.createModelCore("daughterboard.core.cpu0", "ARM_Cortex-R7_0")
        self.createModelCore("daughterboard.core.cpu1", "ARM_Cortex-R7_1")

        self.cluster0cores = []
        self.addModelCoreToCluster(self.cluster0cores, "daughterboard.core.cpu0")
        self.addModelCoreToCluster(self.cluster0cores, "daughterboard.core.cpu1")
    ...
    def setupModelTrace(self):
        ...
        if "daughterboard.core.cpu1" in self.cores.keys():
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "ARM_Cortex-R7 SMP", self.cluster0cores)
