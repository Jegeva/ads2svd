...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.createModelCore("cluster0.cpu2", "Cortex-A75_0", "Cortex-A75")
        self.createModelCore("cluster0.cpu3", "Cortex-A75_1", "Cortex-A75")
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A55x2_Cortex-A75x2 SMP Cluster 0", self.cluster0cores)
