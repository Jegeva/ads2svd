...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.createModelCore("cluster0.cpu0", "ARM_Cortex-A73_0", "Cortex-A73")
        self.createModelCore("cluster0.cpu1", "ARM_Cortex-A73_1", "Cortex-A73")
        self.createModelCore("cluster0.cpu2", "ARM_Cortex-A73_2", "Cortex-A73")
        self.createModelCore("cluster0.cpu3", "ARM_Cortex-A73_3", "Cortex-A73")
        self.createModelCore("cluster1.cpu0", "ARM_Cortex-A53_0", "Cortex-A53")
        self.createModelCore("cluster1.cpu1", "ARM_Cortex-A53_1", "Cortex-A53")
        self.createModelCore("cluster1.cpu2", "ARM_Cortex-A53_2", "Cortex-A53")
        self.createModelCore("cluster1.cpu3", "ARM_Cortex-A53_3", "Cortex-A53")
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "ARM_Cortex-A73x4 SMP", self.cluster0cores)
        self.addDeviceInterface(smp)

        # cluster1 SMP
        smp = CadiSyncSMPDevice(self, "ARM_Cortex-A53x4 SMP", self.cluster1cores)
        self.addDeviceInterface(smp)
    ...
    def setupCadiBigLittle(self):
        ...
        bigLITTLE = CadiSyncSMPDevice(self, "Cortex-A73/A53 big.LITTLE", cores)
