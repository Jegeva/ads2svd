...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores["armcortexm4ct"] = Device(self, self.findDevice("armcortexm4ct"), "ARM_Cortex-M4" )
    ...
    def setupModelTrace(self):
        ...
        self.tracecapture.addTraceSource(fmtSource, self.cores["armcortexm4ct"].getID())
        fmtSource.setEnabled(True)


    def exposeCores(self):
        '''Expose cores'''
        self.addDeviceInterface(self.cores["armcortexm4ct"])
