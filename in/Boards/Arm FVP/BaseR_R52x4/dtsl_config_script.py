...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.createModelCore("cluster0.cpu0", "ARM_Cortex-R52_0")
        self.createModelCore("cluster0.cpu1", "ARM_Cortex-R52_1")
        self.createModelCore("cluster0.cpu2", "ARM_Cortex-R52_2")
        self.createModelCore("cluster0.cpu3", "ARM_Cortex-R52_3")
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "ARM_Cortex-R52x4 SMP", self.cluster0cores)
