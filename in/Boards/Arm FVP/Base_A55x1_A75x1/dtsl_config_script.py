...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.createModelCore("cluster0.cpu0", "Cortex-A55", "Cortex-A55")
        self.createModelCore("cluster0.cpu1", "Cortex-A75", "Cortex-A75")
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A55x1_Cortex-A75x1 SMP Cluster 0", self.cluster0cores)
