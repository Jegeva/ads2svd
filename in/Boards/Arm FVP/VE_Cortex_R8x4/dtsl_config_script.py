...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.cores["daughterboard.core.cpu0"] = Device(self, self.findDevice("daughterboard.core.cpu0"), "ARM_Cortex-R8_0" )
        self.cores["daughterboard.core.cpu1"] = Device(self, self.findDevice("daughterboard.core.cpu1"), "ARM_Cortex-R8_1" )
        self.cores["daughterboard.core.cpu2"] = Device(self, self.findDevice("daughterboard.core.cpu2"), "ARM_Cortex-R8_2" )
        self.cores["daughterboard.core.cpu3"] = Device(self, self.findDevice("daughterboard.core.cpu3"), "ARM_Cortex-R8_3" )

        self.cluster0cores = []
        self.cluster0cores.append(self.cores["daughterboard.core.cpu0"])
        self.cluster0cores.append(self.cores["daughterboard.core.cpu1"])
        self.cluster0cores.append(self.cores["daughterboard.core.cpu2"])
        self.cluster0cores.append(self.cores["daughterboard.core.cpu3"])
    ...
    def setupModelTrace(self):
        ...
        self.traceSources.append(fmtSource)
        self.tracecapture.addTraceSource(fmtSource, self.cores["daughterboard.core.cpu1"].getID())
        fmtSource.setEnabled(True)

        fmtSource =  FMTraceSource(self, DeviceId+2, StreamId+2, "FMT_2")
        self.traceSources.append(fmtSource)
        self.tracecapture.addTraceSource(fmtSource, self.cores["daughterboard.core.cpu2"].getID())
        fmtSource.setEnabled(True)

        fmtSource =  FMTraceSource(self, DeviceId+3, StreamId+3, "FMT_3")
        self.traceSources.append(fmtSource)
        self.tracecapture.addTraceSource(fmtSource, self.cores["daughterboard.core.cpu3"].getID())
        fmtSource.setEnabled(True)


    def exposeCores(self):
        '''Expose cores'''
        self.addDeviceInterface(self.cores["daughterboard.core.cpu0"])
        self.addDeviceInterface(self.cores["daughterboard.core.cpu1"])
        self.addDeviceInterface(self.cores["daughterboard.core.cpu2"])
        self.addDeviceInterface(self.cores["daughterboard.core.cpu3"])
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "Debug Cortex-R8x4 SMP", self.cluster0cores)
