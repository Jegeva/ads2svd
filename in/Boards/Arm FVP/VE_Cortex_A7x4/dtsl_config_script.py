...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.cores["cluster.cpu0"] = ConnectableDevice(self, self.findDevice("cluster.cpu0"), "ARM_Cortex-A7_0" )
        self.cores["cluster.cpu1"] = ConnectableDevice(self, self.findDevice("cluster.cpu1"), "ARM_Cortex-A7_1" )
        self.cores["cluster.cpu2"] = ConnectableDevice(self, self.findDevice("cluster.cpu2"), "ARM_Cortex-A7_2" )
        self.cores["cluster.cpu3"] = ConnectableDevice(self, self.findDevice("cluster.cpu3"), "ARM_Cortex-A7_3" )
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "ARM_Cortex-A7x4 SMP", self.cluster0cores)
