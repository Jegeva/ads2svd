...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.createModelCore("cluster.cpu3", "ARM_Cortex-A17_3")
        ...
        self.addModelCoreToCluster(self.cluster0cores, "cluster.cpu3")
    ...
    def setupModelTrace(self):
        ...
        if "cluster.cpu3" in self.cores.keys():
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A17x4 SMP", self.cluster0cores)
