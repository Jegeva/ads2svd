...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.createModelCore("cluster0.cpu0", "ARM_Cortex-A57_0", "Cortex-A57")
        self.createModelCore("cluster0.cpu1", "ARM_Cortex-A57_1", "Cortex-A57")
        self.createModelCore("cluster0.cpu2", "ARM_Cortex-A57_2", "Cortex-A57")
        self.createModelCore("cluster0.cpu3", "ARM_Cortex-A57_3", "Cortex-A57")
        self.createModelCore("cluster1.cpu0", "ARM_Cortex-A35_0", "Cortex-A35")
        self.createModelCore("cluster1.cpu1", "ARM_Cortex-A35_1", "Cortex-A35")
        self.createModelCore("cluster1.cpu2", "ARM_Cortex-A35_2", "Cortex-A35")
        self.createModelCore("cluster1.cpu3", "ARM_Cortex-A35_3", "Cortex-A35")
        ...
        self.cluster1cores.append(self.cores["cluster1.cpu1"])
        self.cluster1cores.append(self.cores["cluster1.cpu2"])
        self.cluster1cores.append(self.cores["cluster1.cpu3"])
        ...
        self.caches["cluster0.cpu1.l1icache"] = PVCacheDevice(self, self.findDevice("cluster0.cpu1.l1icache"), "l1icache_1")
        self.caches["cluster0.cpu1.l1dcache"] = PVCacheDevice(self, self.findDevice("cluster0.cpu1.l1dcache"), "l1dcache_1")
        self.caches["cluster0.cpu2.l1icache"] = PVCacheDevice(self, self.findDevice("cluster0.cpu2.l1icache"), "l1icache_2")
        self.caches["cluster0.cpu2.l1dcache"] = PVCacheDevice(self, self.findDevice("cluster0.cpu2.l1dcache"), "l1dcache_2")
        self.caches["cluster0.cpu3.l1icache"] = PVCacheDevice(self, self.findDevice("cluster0.cpu3.l1icache"), "l1icache_3")
        self.caches["cluster0.cpu3.l1dcache"] = PVCacheDevice(self, self.findDevice("cluster0.cpu3.l1dcache"), "l1dcache_3")
        ...
        self.caches["cluster1.cpu1.l1icache"] = PVCacheDevice(self, self.findDevice("cluster1.cpu1.l1icache"), "l1icache_1")
        self.caches["cluster1.cpu1.l1dcache"] = PVCacheDevice(self, self.findDevice("cluster1.cpu1.l1dcache"), "l1dcache_1")
        self.caches["cluster1.cpu2.l1icache"] = PVCacheDevice(self, self.findDevice("cluster1.cpu2.l1icache"), "l1icache_2")
        self.caches["cluster1.cpu2.l1dcache"] = PVCacheDevice(self, self.findDevice("cluster1.cpu2.l1dcache"), "l1dcache_2")
        self.caches["cluster1.cpu3.l1icache"] = PVCacheDevice(self, self.findDevice("cluster1.cpu3.l1icache"), "l1icache_3")
        self.caches["cluster1.cpu3.l1dcache"] = PVCacheDevice(self, self.findDevice("cluster1.cpu3.l1dcache"), "l1dcache_3")
        ...
        self.addPVCache(self.cores["cluster0.cpu1"], self.caches["cluster0.cpu1.l1icache"], self.caches["cluster0.cpu1.l1dcache"], self.caches["cluster0.l2_cache"])
        self.addPVCache(self.cores["cluster0.cpu2"], self.caches["cluster0.cpu2.l1icache"], self.caches["cluster0.cpu2.l1dcache"], self.caches["cluster0.l2_cache"])
        self.addPVCache(self.cores["cluster0.cpu3"], self.caches["cluster0.cpu3.l1icache"], self.caches["cluster0.cpu3.l1dcache"], self.caches["cluster0.l2_cache"])
        ...
        self.addPVCache(self.cores["cluster1.cpu1"], self.caches["cluster1.cpu1.l1icache"], self.caches["cluster1.cpu1.l1dcache"], self.caches["cluster1.l2_cache"])
        self.addPVCache(self.cores["cluster1.cpu2"], self.caches["cluster1.cpu2.l1icache"], self.caches["cluster1.cpu2.l1dcache"], self.caches["cluster1.l2_cache"])
        self.addPVCache(self.cores["cluster1.cpu3"], self.caches["cluster1.cpu3.l1icache"], self.caches["cluster1.cpu3.l1dcache"], self.caches["cluster1.l2_cache"])
    ...
    def exposeCores(self):
        ...
        self.addDeviceInterface(self.cores["cluster1.cpu1"])
        self.addDeviceInterface(self.cores["cluster1.cpu2"])
        self.addDeviceInterface(self.cores["cluster1.cpu3"])
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A57x4 SMP", self.cluster0cores)
        self.addDeviceInterface(smp)

        # cluster1 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A35x4 SMP", self.cluster1cores)
        self.addDeviceInterface(smp)
    ...
    def setupCadiBigLittle(self):
        ...
        bigLITTLE = CadiSyncSMPDevice(self, "Cortex-A57/A35 big.LITTLE", cores)
