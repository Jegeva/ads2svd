...
class DtslScript(DTSLv1):
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A57x2 SMP0", self.cluster0cores)
        self.addDeviceInterface(smp)

        # cluster1 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A53x4 SMP1", self.cluster1cores)
        self.addDeviceInterface(smp)
    ...
    def setupCadiBigLittle(self):
        ...
        bigLITTLE = CadiSyncSMPDevice(self, "Cortex-A57/A53 big.LITTLE", cores)
