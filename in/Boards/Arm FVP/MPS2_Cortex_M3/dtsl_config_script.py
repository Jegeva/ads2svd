...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores["armcortexm3ct"] = Device(self, self.findDevice("armcortexm3ct"), "ARM_Cortex-M3" )
    ...
    def setupModelTrace(self):
        ...
        self.tracecapture.addTraceSource(fmtSource, self.cores["armcortexm3ct"].getID())
        fmtSource.setEnabled(True)


    def exposeCores(self):
        '''Expose cores'''
        self.addDeviceInterface(self.cores["armcortexm3ct"])
