...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores = dict()
        self.cores["cluster0.cpu0"] = Device(self, self.findDevice("cluster0.cpu0"), "Cortex-A75_0" )
        self.cores["cluster0.cpu1"] = Device(self, self.findDevice("cluster0.cpu1"), "Cortex-A75_1" )
        self.cores["cluster0.cpu2"] = Device(self, self.findDevice("cluster0.cpu2"), "Cortex-A75_2" )
        self.cores["cluster0.cpu3"] = Device(self, self.findDevice("cluster0.cpu3"), "Cortex-A75_3" )
