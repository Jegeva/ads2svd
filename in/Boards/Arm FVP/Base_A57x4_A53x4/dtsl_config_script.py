...
class DtslScript(DTSLv1):
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A57 SMP", self.cluster0cores)
        self.addDeviceInterface(smp)

        # cluster1 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A53 SMP", self.cluster1cores)
        self.addDeviceInterface(smp)
    ...
    def setupCadiBigLittle(self):
        ...
        bigLITTLE = CadiSyncSMPDevice(self, "ARM_Cortex_A57_A53_big_LITTLE", cores)
