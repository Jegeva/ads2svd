...
class fvp_ARM_Cortex_A57_SMP(DTSLv1):
    @staticmethod
    def getOptionList():
        return [
    ...
    def discoverDevices(self):
        ...
        self.cores["cluster.cpu0"] = ConnectableDevice(self, self.findDevice("cluster.cpu0"), "ARM_Cortex-A57_0" )
        self.cores["cluster.cpu1"] = ConnectableDevice(self, self.findDevice("cluster.cpu1"), "ARM_Cortex-A57_1" )
        self.cores["cluster.cpu2"] = ConnectableDevice(self, self.findDevice("cluster.cpu2"), "ARM_Cortex-A57_2" )
        self.cores["cluster.cpu3"] = ConnectableDevice(self, self.findDevice("cluster.cpu3"), "ARM_Cortex-A57_3" )
    ...
    def setupCadiSyncSMP(self):
        ...
        # cluster0 SMP
        smp = CadiSyncSMPDevice(self, "Cortex-A57x4_SMP", self.cluster0cores)
