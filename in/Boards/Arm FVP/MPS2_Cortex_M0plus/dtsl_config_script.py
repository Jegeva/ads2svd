...
class DtslScript(DTSLv1):
    ...
    def discoverDevices(self):
        ...
        self.cores["armcortexm0plusct"] = Device(self, self.findDevice("armcortexm0plusct"), "ARM_Cortex-M0+" )
    ...
    def setupModelTrace(self):
        ...
        self.tracecapture.addTraceSource(fmtSource, self.cores["armcortexm0plusct"].getID())
        fmtSource.setEnabled(True)


    def exposeCores(self):
        '''Expose cores'''
        self.addDeviceInterface(self.cores["armcortexm0plusct"])
