...
class DtslScript(DTSLv1):
                ...
                DTSLv1.tabPage('cortexA15', 'Cortex-A15', childOptions=[
                    DTSLv1.booleanOption('coreTrace', 'Enable Cortex-A15 core trace', defaultValue=False,
                        childOptions =
                            ...
                            [ DTSLv1.booleanOption('timestamp', "Enable PTM Timestamps", description="Controls the ouptut of timestamps into the PTM output streams", defaultValue=True) ] +
    ...
    def setupDSTREAMTrace(self, portwidth):
        ...
        self.DSTREAM.setTraceComponentOrder([ self.tpiu, self.funnel0,  ])
